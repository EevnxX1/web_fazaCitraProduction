    ...
    <div class="w-full h-[500px] max-[1534px]:h-[480px] max-[1279px]:h-[400px] bg-color1 mt-36">
        <div class="container mx-auto flex justify-center h-full">
            <div class="w-4/5 flex justify-between h-full max-[1534px]:ml-8 max-[1279px]:ml-12">
                <h1 class="text-5xl max-[1534px]:text-4xl max-[1279px]:text-3xl text-white font-akira w-[480px] max-[1279px]:w-[520px] self-center">APa sih <br>
                    self publish <br>
                    itu?</h1>
                <div>
        ...
        <div class="container flex justify-end mr-40">
            <div class="w-11/12 h-max flex justify-between">
                <div class="flex flex-col gap-y-11 self-center">
                    <h3 class="text-3xl font-akira text-color1">jadi self publish itu . . .</h3>
                    <div class="text-2xl text-justify max-[1579px]:text-xl max-[1439px]:text-lg font-inter w-[650px] max-[1579px]:w-[550px] max-[1439px]:w-[500px] flex flex-col gap-y-8">
                        <p>Self publishing secara umum adalah cetak buku sendiri, tanpa bantuan penerbit dan menggunakan dana untuk cetak maupun pra cetak. Self Publish sama dengan penerbitan mandiri atau menerbitkan buku sendiri.</p>
                        <p>Sehingga tanggung jawab ada di tangan si penulis itu sendiri, mulai proses menulis naskah, editing, desain cover, dan tata letak buku.</p>
                    </div>
...
{{-- page3 --}}
    <h1 class="font-akira text-3xl text-color1 w-max mx-auto mb-20">Buku self publish yang sudah terbit</h1>
